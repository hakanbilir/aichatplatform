        ...
        <BentoGrid>
          ...
          >
            ...
            <Typography variant="body1" sx={{ mb: 4, opacity: 0.8, maxWidth: 400 }}>
              Agentic workflows powered by Node.js 24+ and server-sent events.
              Seamless, refractive, and responsive.
            </Typography>
          ...
          <GlassPanel refractive={!isEcoMode} sx={{ gridColumn: { xs: 'span 1', md: 'span 2' }, p: 3, minHeight: 180, display: 'flex', alignItems: 'center' }}>
             <Box display="flex" gap={4} alignItems="center" width="100%">
                ...
                <Box>
                    ...
                    <Typography variant="body1" color="text.secondary">
                        Share conversations, manage organizations, and work together with context-aware AI agents.
                    </Typography>
                </Box>
             </Box>
          </GlassPanel>
