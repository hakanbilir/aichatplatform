...
export const ChatPage: React.FC = () => {
  ...
  const {
    ...
    handleChangeTopP,
  } = useConversationSettings(conversation, token, (updated) => {
      ...
      >
        ...
        <Box width={160} px={1}>
          ...
          <Slider
            ...
            max={2}
            step={0.1}
            onChange={(_e, val) => handleChangeTemperature(Array.isArray(val) ? val[0] : val)}
          />
        </Box>
        ...
        <Box width={130} px={1}>
          ...
          <Slider
            ...
            max={1}
            step={0.05}
            onChange={(_e, val) => handleChangeTopP(Array.isArray(val) ? val[0] : val)}
          />
        </Box>
