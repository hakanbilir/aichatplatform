  ...
  app.post('/api/v1/auth/login', async (request, reply) => {
    ...
    if (!user) {
      if (isDemoMode) {
        ...
        // Valid bcrypt hash (cost 10) to ensure timing matches real verifications (~100ms)
        const dummyHash = '$2b$10$FU8fFFhhaLGTzaQ3jX61Tu4CZXTR3BqfIDiWSYfLnQRGqOwzrcdle';
