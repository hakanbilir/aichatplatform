...
export interface ChatMessage {
  ...
  createdAt?: string;
  /**
   * Optional images for multimodal models (base64 or URL).
   * Multimodal modeller için opsiyonel görseller (base64 veya URL).
   */
  images?: string[];
  /**
   * Tool calls generated by the model.
   * Model tarafından üretilen tool çağrıları.
   */
  toolCalls?: ToolCall[];
  /**
   * Tool result if this is a tool message.
   * Bu bir tool mesajı ise tool sonucu.
   */
...
export type ChatStreamEventType = 'start' | 'token' | 'end' | 'error' | 'tool_call' | 'tool_result';
