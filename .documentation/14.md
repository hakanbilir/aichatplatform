    ...
    <Box display="flex" flexDirection="column" flex={1}>
      ...
      >
        <Box
          flex={1}
          minWidth={0}
          sx={{ cursor: conversation ? 'text' : 'default' }}
          onClick={!editingTitle ? beginEditTitle : undefined}
        >
          {editingTitle ? (
            <TextField
              variant="standard"
        ...
        <Box display="flex" alignItems="center" gap={1}>
          ...
          <Tooltip
            title={dirty ? 'Save settings for this conversation' : 'Settings are up to date'}
          >
            <span>
              <IconButton
                size="small"
        ...
        >
          <Box display="flex" alignItems="center" justifyContent="space-between">
            <Box>
              ...
              <Typography variant="caption" color="text.secondary">
                Shape the assistant&apos;s behavior for this conversation. Leave empty for the
                default behavior.
              </Typography>
            </Box>
