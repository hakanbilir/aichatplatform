...
export async function fetchExperiments(
  ...
  return apiRequest<{ experiments: any[] }>(`/orgs/${orgId}/experiments`, { method: 'GET' }, token);
}
...
export const ExperimentsPage: React.FC = () => {
  ...
  const renderRunsTable = () => {
    ...
    return (
      <Box
        sx={{ display: 'flex', flexDirection: 'column', gap: 1, maxHeight: 520, overflow: 'auto' }}
      >
    ...
    >
                ...
                <Card sx={{ borderRadius: 3 }}>
                  <CardContent sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                    ...
                    <Box display="flex" justifyContent="flex-end" mt={0.5}>
                      <Button
                        size="small"
                        onClick={() => void handleAddInputs()}
                        disabled={!inputsText.trim()}
                      >
                        Add inputs
                      </Button>
                    </Box>
      ...
      >
        ...
        <DialogActions>
          ...
          <Button onClick={() => void handleCreateExperiment()} disabled={!newName.trim()}>
            Create
          </Button>
        </DialogActions>
      </Dialog>
      ...
      >
        ...
        <DialogActions>
          ...
          <Button onClick={() => void handleAddVariant()} disabled={!variantName.trim()}>
            Add variant
          </Button>
        </DialogActions>
      </Dialog>
