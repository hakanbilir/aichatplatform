...
export async function buildOidcRedirectUrl(
  config: any,
  state: string,
  nonce: string,
): Promise<string> {
        ...
        <CardContent sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          <Box display="flex" gap={2} alignItems="center">
            ...
            <TextField
              ...
              onChange={(e) =>
                setConnection((prev) => (prev ? { ...prev, name: e.target.value } : null))
              }
            />
          </Box>
            ...
            <Box display="flex" flexDirection="column" gap={1.5}>
              ...
              <TextField
                ...
                onChange={(e) =>
                  setConnection((prev) =>
                    prev
                      ? { ...prev, config: { ...prev.config, idpSsoUrl: e.target.value } }
                      : prev,
                  )
                }
              />
